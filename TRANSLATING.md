...
- 카탈로그 위치: **[`src/LyricsX.App/i18n/`](https://github.com/countnine/LyricsX-Windows/tree/master/src/LyricsX.App/i18n)** (예: `ko.json`, `ja.json`, `de.json`)
...
[**번역 제안 이슈 열기**](https://github.com/countnine/LyricsX-Windows/issues/new?template=translation.yml) →
...
지원 언어 목록은 [`Services/Localization.cs`](https://github.com/countnine/LyricsX-Windows/blob/master/src/LyricsX.App/Services/Localization.cs)의
`SupportedLanguages`에 있습니다. 새 언어는 그 목록에 `LanguageOption(코드, 자국어표기)` 를 넣고
`src/LyricsX.App/i18n/<코드>.json` 을 만들면 됩니다(없으면 영어로 폴백).

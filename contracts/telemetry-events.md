...
| `translation` | ① | `engine`, `cacheHitPct`(0–100 정수), `linesBucket`("1-10"/"11-50"/"51+") | 세션 집계로 전송 |
| `feature_use` | ① | `feature`(mediaControls/edit/export/offset/search/karaoke…), `count`(int) | 세션 집계로 전송 |

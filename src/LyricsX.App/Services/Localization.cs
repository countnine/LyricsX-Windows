...
/// <summary>
/// UI 다국어(i18n) 조회 서비스.
/// - 로케일별 JSON 카탈로그(임베디드 리소스 <c>LyricsX.App.i18n.&lt;code&gt;.json</c>)를 읽어 키→문자열 조회.
...
public static class Loc
{
    ...
    public const string ContributionUrl = "https://github.com/countnine/LyricsX-Windows/blob/master/TRANSLATING.md";
    ...
    private static Dictionary<string, string>? LoadCatalog(string code)
    {
        ...
        using var stream = asm.GetManifestResourceStream($"LyricsX.App.i18n.{code}.json");
